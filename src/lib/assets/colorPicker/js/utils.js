...
EYE.extend({
	...
	getClient : function(e)
	{
		...
		if (e) {
			...
			w = window.innerWidth || e.target.innerWidth || (de&&de.clientWidth) || document.body.clientWidth;
			h = window.innerHeight || e.target.innerHeight || (de&&de.clientHeight) || document.body.clientHeight;
		}
		return {w:w,h:h};
	},
	getScroll : function (e)
	{
		...
		if (e && e.nodeName.toLowerCase() != 'body') {
			...
			// 	l = pageXOffset;
			// }
			iw = e.target.innerWidth||document.documentElement.clientWidth||document.body.clientWidth||0;
			ih = e.target.innerHeight||document.documentElement.clientHeight||document.body.clientHeight||0;
		}
